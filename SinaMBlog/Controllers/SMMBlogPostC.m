...
{
    [super viewDidLoad];
    //[self layoutViewsWithKeyboardHeight:NIToolbarHeightForOrientation(self.interfaceOrientation)];
...
//    [SMGlobalConfig setBackgroundImageForNavigationBar:self.navigationController.navigationBar];
}
